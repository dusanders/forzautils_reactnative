...
import { useTrackMapViewModel } from "./TrackMapViewModel";
...
export function TrackMap(props: TrackMapProps) {
  ...
  const viewModel = useTrackMapViewModel();
  ...
  return (
    <Paper style={props.style}>
      ...
      <Svg height={viewModel.svgHeight} width={viewModel.svgWidth}
        ...
        <Path
          d={viewModel.svgPath}
          stroke={theme.theme.colors.text.secondary.onPrimary}
        ...
        <Circle
          ...
          fill={theme.theme.colors.text.primary.onPrimary} />
      </Svg>
    </Paper>
  )
}